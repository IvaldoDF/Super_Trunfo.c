...
int main() {
    ...
    unsigned long float superpoder1 = (populacao1 + area1 + pib1 + pontosturisticos1 + pibcapita1 + 1/densidadepop1);
    ...
    unsigned long float superpoder2 = (populacao2 + area2 + pib2 + pontosturisticos2 +pibcapita2 + 1/densidadepop2);
